...
import { addTagToNote, batchCreateNotes, createNote, deleteNote, getNote, getNotes, updateNote } from "../handlers/notes.js";
import { validateNote } from "../middleware/validate-notes.js";
import { createRateLimiter } from "../middleware/rate-limit.js";
import { validateNoteUpdate } from "../middleware/validate-note-update.js";
...
router.post("/batch", batchCreateNotes);
